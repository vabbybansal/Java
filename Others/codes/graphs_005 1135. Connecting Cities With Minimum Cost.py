...
class Solution(object):
    def minimumCost(self, N, connections):
        ...
        graph.createWeightedUndirectedGraphFromEdgeList(connections, True)
        if N > len(graph.nodes):
            return -1
        return graph.minSpanningTreeWeightSum()
...
# print graph
obj = Solution()
print obj.minimumCost(3, [[1,2,5],[1,3,6],[2,3,1]])
print obj.minimumCost(5, [[2,1,3267],[3,2,25910],[4,1,30518]])
