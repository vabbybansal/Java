...
#
#     def getSide(self, elm, parent):
#
#         elmSide = self.dictionarySets[elm].side
#         parentViolation = self.dictionarySets[parent].sideViolation
#         if parentViolation == True:
#             if elmSide == 'l':
#                 return 'r'
#             else:
#                 return 'l'
...
#         if (aRepresentedBy == False or bRepresentedBy == False):
#             return
#
#         # Present in the same component, check if sides are different, else return False
#         if aRepresentedBy == bRepresentedBy:
#             if self.dictionarySets[a].side == self.dictionarySets[b].side:
#                 return False
#
#         # Present in different sets
#         else:
#             # if either ones of these has no side assignment, simply assign the opposite to the other
#             sideA = self.getSide(a, aRepresentedBy)
#             sideB = self.getSide(b, bRepresentedBy)
#             if sideA == None and sideB == None:
#
