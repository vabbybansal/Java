...
public class TaskLab {
    ...
    private static ContentValues getContentValues(Task task){
        ...
        contentValues.put(TaskDBSchema.AllTasksTable.Cols.TASK_DATE, task.getTask_date().getTime());
        ...
        contentValues.put(TaskDBSchema.AllTasksTable.Cols.DATE_CREATED, task.getDate_created().getTime());
        contentValues.put(TaskDBSchema.AllTasksTable.Cols.DATE_DONE, task.getDate_done().getTime());
